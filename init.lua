...
--custom keymaps
vim.keymap.set('n', 'tt', function() vim.cmd 'split | terminal' end, { desc = 'open terminal' })
          ...
          java = {
            configuration = {
              runtimes = {
                {
                  name = 'JavaSE-11',
                  path = '/Users/rahulgajananhegde/Library/Java/JavaVirtualMachines/ms-11.0.30/Contents/Home',
                },
                {
                  name = 'JavaSE-21',
